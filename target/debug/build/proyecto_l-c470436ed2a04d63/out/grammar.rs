...
// sha3: 37519bbc4bc1b0cad7cf9e94e4a6258718d954d08997b4d2fd5de2bf21e77924
use std::str::FromStr;
...
mod __parse__Expr {
    ...
    {
        // Expr = Expr, Plus, Term => ActionFn(14);
    ...
    {
        // Expr = Expr, Minus, Term => ActionFn(15);
        assert!(__symbols.len() >= 3);
        let __sym2 = __pop_Variant1(__symbols);
        let __sym1 = __pop_Variant2(__symbols);
        let __sym0 = __pop_Variant1(__symbols);
    ...
    {
        // Term = LParen, Term, RParen => ActionFn(13);
        assert!(__symbols.len() >= 3);
...
mod __parse__LParen {
    ...
    pub struct LParenParser {
        builder: __lalrpop_util::lexer::MatcherBuilder,
        _priv: (),
    }

    impl Default for LParenParser { fn default() -> Self { Self::new() } }
    impl LParenParser {
        pub fn new() -> LParenParser {
            let __builder = super::__intern_token::new_builder();
            LParenParser {
                builder: __builder,
                _priv: (),
...
#[allow(unused_imports)]
pub use self::__parse__LParen::LParenParser;
...
mod __parse__Minus {
    ...
    pub struct MinusParser {
        builder: __lalrpop_util::lexer::MatcherBuilder,
        _priv: (),
    }

    impl Default for MinusParser { fn default() -> Self { Self::new() } }
    impl MinusParser {
        pub fn new() -> MinusParser {
            let __builder = super::__intern_token::new_builder();
            MinusParser {
                builder: __builder,
                _priv: (),
...
#[allow(unused_imports)]
pub use self::__parse__Minus::MinusParser;
...
mod __parse__Plus {
    ...
    pub struct PlusParser {
        builder: __lalrpop_util::lexer::MatcherBuilder,
        _priv: (),
    }

    impl Default for PlusParser { fn default() -> Self { Self::new() } }
    impl PlusParser {
        pub fn new() -> PlusParser {
            let __builder = super::__intern_token::new_builder();
            PlusParser {
                builder: __builder,
                _priv: (),
...
#[allow(unused_imports)]
pub use self::__parse__Plus::PlusParser;
...
mod __parse__RParen {
    ...
    pub struct RParenParser {
        builder: __lalrpop_util::lexer::MatcherBuilder,
        _priv: (),
    }

    impl Default for RParenParser { fn default() -> Self { Self::new() } }
    impl RParenParser {
        pub fn new() -> RParenParser {
            let __builder = super::__intern_token::new_builder();
            RParenParser {
                builder: __builder,
                _priv: (),
...
#[allow(unused_imports)]
pub use self::__parse__RParen::RParenParser;
